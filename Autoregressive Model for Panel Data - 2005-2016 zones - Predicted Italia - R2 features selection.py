...
directory = "/home/sara/Documents/Immigration/Shared_models/Plot_%d_%d" % (
    years[0], years[-1])
...
), False, palette, "Spatial Error Model", save=True, path=directory+"/spatial_autocorr_model_%s" %c.lower(), data_hat=y_italia_pred, train_test=True)
res_pred
